...
<template>
  ...
  <section>
    ...
    <div class="links">
      ...
      <p class="tip">为了更好地了解您的需求，提供精准和个性化的教育规划服务，请提交您孩子的基础信息。请放心，我们会确保所有收集到的信息得到充分保护。</p>
    </div>
  </section>
  <div class="mask">
    <div class="con">
      <div class="box">
        ...
        <img alt="" src="">
        <div class="tip">
          <p>时间：2024年10月19日 周六08:30-16:00</p>
          <p>地址：深圳文华东方酒店4楼</p>
        </div>
      </div>
      <img alt="" src="//m.ieduchina.com//wxpay/zhanhui/202410/images/5ddcd19c.png" class="close">
    </div>
  </div>
  <footer><a href="/m/zhan">首页</a><a>签到码</a></footer>
</template>
