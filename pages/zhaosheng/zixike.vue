...
<template>
  ...
  <section>
    ...
    <p>1.<b>核心服务</b>：</p>
    <p class="indent">
      <component :is="CheckMarkRem" />监督学生完成<b>本校区当前正课科目老师布置的作业</b>。
    </p>
    <p class="indent">
      <component :is="CheckMarkRem" />提供基础的<b>本校区当前正课科目老师布置的作业</b>>完成情况监督与纪律管理。
    </p>
    <p class="indent">
      <component :is="CheckMarkRem" />进行简单的、与<b>本校区当前正课科目老师布置的作业</b>相关的知识点提示和辅助（<b>不包含详细的知识点讲解或题目答疑</b>）。
    </p>
    <p class="indent">
      <component :is="CheckMarkRem" />定期向家长、正课老师及顾问反馈学生的自习表现。
    </p>
    <p>2.<b>明确边界 (学管老师无法提供以下服务)</b>：</p>
    <p class="indent">
      <component :is="CheckMarkRem" /><b>不辅助</b>学生在<b>其他机构、学校或家长额外布置</b>的作业。
    </p>
    <p class="indent">
      <component :is="CheckMarkRem" /><b>不辅导</b>学生正课&lt;未涉及的其他科目&gt;内容（例如：学生正课为数学，学管不辅导英语作业）。
    </p>
    <h2>三、 自习课安排规则</h2>
    ...
    <p class="indent0">
      •禁止携带与学习无关的电子设备（如游戏机、平板电脑等，手机需交由学管暂存，特殊情况需使用时需经学管同意）进入自习室，可在自习室外使用。
    </p>
    <p class="indent0">
      •禁止交头接耳、讨论题目或大声喧哗，禁止随意走动、跑闹。
    </p>
    <p class="indent0">
      •禁止在自习室乱扔垃圾，需保持座位及周边环境整洁；
    </p>
    <p class="indent0">
      •禁止抄袭他人作业或干扰他人学习，需独立完成任务。
    </p>
    <h2>五、 纪律违规处理</h2>
