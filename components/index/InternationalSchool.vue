  ...
  <div class="school">
    <div class="school-con">
      ...
      <ul id="school-title" class="school-title">
        ...
        <li>
          <a href="//schoollist.ieduchina.com/schlist/c2-p21-c328-g0-s0/">深圳</a>
        </li>
        <li>
          <a href="//schoollist.ieduchina.com/schlist/c2-p34-c0-g0-s0/">香港</a>
        </li>
        <li>
          <a href="//schoollist.ieduchina.com/schlist/c2-p21-c326-g0-s0/">广州</a>
        </li>
        <li>
          <a href="//schoollist.ieduchina.com/schlist/c2-p2-c0-g0-s0/">北京</a>
        </li>
        <li>
          <a href="//schoollist.ieduchina.com/schlist/c2-p3-c0-g0-s0/">上海</a>
        </li>
        <li>
          <a href="//schoollist.ieduchina.com/schlist/c2-p13-c213-g0-s0/">杭州</a>
        </li>
        <li>
          <a href="//schoollist.ieduchina.com">更多</a>
        </li>
      </ul>
...
body .school .school-con .school-list li .box .bottom div.rimg {
  ...
  background-image: url(https://www.ieduchina.com/statics/pcc/img/msg.png?v=1);
}
</style>